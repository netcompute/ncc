...
%token <token> TLPAREN TRPAREN TLBRACE TRBRACE TCOMMA TEQUAL TIF TELSE TCEQ TCNE TCLT TCLE TCGT TCGE TPLUS TMINUS TMUL TDIV TRETURN TAND TOR TXOR TMOD TSHIFTR TSHIFTL TSTRUCT
